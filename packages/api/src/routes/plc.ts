 ...
 */
plcRouter.post(
  '/xrpc/io.exprsn.plc.reserveHandle',
  adminAuthMiddleware,
 ...
 */
plcRouter.post(
  '/xrpc/io.exprsn.plc.releaseHandle',
  adminAuthMiddleware,
  requirePermission(ADMIN_PERMISSIONS.CONFIG_EDIT),
  async (c) => {
 ...
 */
plcRouter.post(
  '/xrpc/io.exprsn.plc.updateConfig',
  adminAuthMiddleware,
  requirePermission(ADMIN_PERMISSIONS.CONFIG_EDIT),
  async (c) => {
 ...
 */
plcRouter.post(
  '/xrpc/io.exprsn.plc.tombstoneDid',
  adminAuthMiddleware,
 ...
 */
plcRouter.get(
  '/xrpc/io.exprsn.plc.listIdentities',
  adminAuthMiddleware,
 ...
 */
plcRouter.get(
  '/xrpc/io.exprsn.plc.fullValidation',
  adminAuthMiddleware,
  requirePermission(ADMIN_PERMISSIONS.USERS_VIEW),
  async (c) => {
    const did = c.req.query('did');
